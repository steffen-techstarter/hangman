...
const flowerObject = {
	4: 'flowergifs/4flower.gif',
	3: 'flowergifs/3flower.gif',
	2: 'flowergifs/2flower.gif',
	1: 'flowergifs/1flower.gif',
	0: 'flowergifs/0flower.gif',
};
...
const flowerDisappear = () => {
	flower.style.animation = 'fadeOut100 5s forwards';
...
const clickEvent = (e) => {
	...
	if (wordArray.includes(e.currentTarget.value)) {
		...
		flower.style.backgroundImage = 'url(' + flowerObject[leben] + ')';
		console.log(flowerObject[leben]);
		...
		if (leben > 0) {
			...
			setTimeout(flowerDisappear, 1300);
		}
	}
	// Gewonnen
